...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='/Users/timothyv/Cloud/Google Drive/Code/WythoffsHumanExp/WythoffsHumanExp_lastrun.py',
...
def run(expInfo, thisExp, win, inputs, globalClock=None, thisSession=None):
    ...
    thisExp.addData('setup_instruct.started', globalClock.getTime())
    ...
    thisExp.addData('setup_instruct.stopped', globalClock.getTime())
    ...
    continueRoutine = True
    # update component parameters for each repeat
    thisExp.addData('practice_info.started', globalClock.getTime())
    ...
    for thisComponent in practice_infoComponents:
        if hasattr(thisComponent, "setAutoDraw"):
            thisComponent.setAutoDraw(False)
    thisExp.addData('practice_info.stopped', globalClock.getTime())
    # store data for thisExp (ExperimentHandler)
    thisExp.nextEntry()
    ...
    if thisPractice_game != None:
        for paramName in thisPractice_game:
            globals()[paramName] = thisPractice_game[paramName]
    ...
    for thisPractice_game in practice_games:
        ...
        if thisPractice_turn != None:
            for paramName in thisPractice_turn:
                globals()[paramName] = thisPractice_turn[paramName]
        ...
        for thisPractice_turn in practice_turns:
            ...
            continueRoutine = True
            # update component parameters for each repeat
            thisExp.addData('select_move.started', globalClock.getTime())
            ...
            for thisComponent in select_moveComponents:
                if hasattr(thisComponent, "setAutoDraw"):
                    thisComponent.setAutoDraw(False)
            thisExp.addData('select_move.stopped', globalClock.getTime())
            ...
            continueRoutine = True
            # update component parameters for each repeat
            thisExp.addData('make_move.started', globalClock.getTime())
            ...
            for thisComponent in make_moveComponents:
                if hasattr(thisComponent, "setAutoDraw"):
                    thisComponent.setAutoDraw(False)
            thisExp.addData('make_move.stopped', globalClock.getTime())
            ...
            continueRoutine = True
            # update component parameters for each repeat
            thisExp.addData('npc_wait.started', globalClock.getTime())
            ...
            for thisComponent in npc_waitComponents:
                if hasattr(thisComponent, "setAutoDraw"):
                    thisComponent.setAutoDraw(False)
            thisExp.addData('npc_wait.stopped', globalClock.getTime())
            ...
            continueRoutine = True
            # update component parameters for each repeat
            thisExp.addData('npc_move.started', globalClock.getTime())
            ...
            for thisComponent in npc_moveComponents:
                if hasattr(thisComponent, "setAutoDraw"):
                    thisComponent.setAutoDraw(False)
            thisExp.addData('npc_move.stopped', globalClock.getTime())
        ...
        continueRoutine = True
        # update component parameters for each repeat
        thisExp.addData('end_pause.started', globalClock.getTime())
        ...
        for thisComponent in end_pauseComponents:
            if hasattr(thisComponent, "setAutoDraw"):
                thisComponent.setAutoDraw(False)
        thisExp.addData('end_pause.stopped', globalClock.getTime())
    ...
    if thisDouble_click_1 != None:
        for paramName in thisDouble_click_1:
            globals()[paramName] = thisDouble_click_1[paramName]
    ...
    for thisDouble_click_1 in double_click_1:
        ...
        continueRoutine = True
        # update component parameters for each repeat
        thisExp.addData('section_1.started', globalClock.getTime())
        ...
        for thisComponent in section_1Components:
            if hasattr(thisComponent, "setAutoDraw"):
                thisComponent.setAutoDraw(False)
        thisExp.addData('section_1.stopped', globalClock.getTime())
    ...
    if thisGame != None:
        for paramName in thisGame:
            globals()[paramName] = thisGame[paramName]
    ...
    for thisGame in games:
        ...
        if thisTurn != None:
            for paramName in thisTurn:
                globals()[paramName] = thisTurn[paramName]
    ...
    continueRoutine = True
    # update component parameters for each repeat
    thisExp.addData('instruct_recall.started', globalClock.getTime())
    ...
    for thisComponent in instruct_recallComponents:
        if hasattr(thisComponent, "setAutoDraw"):
            thisComponent.setAutoDraw(False)
    thisExp.addData('instruct_recall.stopped', globalClock.getTime())
    # store data for thisExp (ExperimentHandler)
    thisExp.nextEntry()
    ...
    continueRoutine = True
    # update component parameters for each repeat
    thisExp.addData('instruct_imagine.started', globalClock.getTime())
    ...
    for thisComponent in instruct_imagineComponents:
        if hasattr(thisComponent, "setAutoDraw"):
            thisComponent.setAutoDraw(False)
    thisExp.addData('instruct_imagine.stopped', globalClock.getTime())
    # store data for thisExp (ExperimentHandler)
    thisExp.nextEntry()
    ...
    continueRoutine = True
    # update component parameters for each repeat
    thisExp.addData('instruct_blink.started', globalClock.getTime())
    ...
    for thisComponent in instruct_blinkComponents:
        if hasattr(thisComponent, "setAutoDraw"):
            thisComponent.setAutoDraw(False)
    thisExp.addData('instruct_blink.stopped', globalClock.getTime())
    # store data for thisExp (ExperimentHandler)
    thisExp.nextEntry()
    ...
    if thisDouble_click_2 != None:
        for paramName in thisDouble_click_2:
            globals()[paramName] = thisDouble_click_2[paramName]
    ...
    for thisDouble_click_2 in double_click_2:
        ...
        continueRoutine = True
        # update component parameters for each repeat
        thisExp.addData('section_2.started', globalClock.getTime())
        ...
        for thisComponent in section_2Components:
            if hasattr(thisComponent, "setAutoDraw"):
                thisComponent.setAutoDraw(False)
        thisExp.addData('section_2.stopped', globalClock.getTime())
    ...
    if thisIntervention_game != None:
        for paramName in thisIntervention_game:
            globals()[paramName] = thisIntervention_game[paramName]
    ...
    for thisIntervention_game in intervention_games:
        ...
        continueRoutine = True
        # update component parameters for each repeat
        thisExp.addData('intervention_countdown.started', globalClock.getTime())
        ...
        for thisComponent in intervention_countdownComponents:
            if hasattr(thisComponent, "setAutoDraw"):
                thisComponent.setAutoDraw(False)
        thisExp.addData('intervention_countdown.stopped', globalClock.getTime())
        # using non-slip timing so subtract the expected duration of this Routine (unless ended on request)
        if routineForceEnded:
            routineTimer.reset()
        else:
        ...
        continueRoutine = True
        # update component parameters for each repeat
        thisExp.addData('imagination_prompt.started', globalClock.getTime())
        ...
        for thisComponent in imagination_promptComponents:
            if hasattr(thisComponent, "setAutoDraw"):
                thisComponent.setAutoDraw(False)
        thisExp.addData('imagination_prompt.stopped', globalClock.getTime())
        ...
        continueRoutine = True
        # update component parameters for each repeat
        thisExp.addData('blink.started', globalClock.getTime())
        ...
        for thisComponent in blinkComponents:
            if hasattr(thisComponent, "setAutoDraw"):
                thisComponent.setAutoDraw(False)
        thisExp.addData('blink.stopped', globalClock.getTime())
        ...
        continueRoutine = True
        # update component parameters for each repeat
        thisExp.addData('post_blink.started', globalClock.getTime())
        ...
        for thisComponent in post_blinkComponents:
            if hasattr(thisComponent, "setAutoDraw"):
                thisComponent.setAutoDraw(False)
        thisExp.addData('post_blink.stopped', globalClock.getTime())
        ...
        if thisIntervention_move != None:
            for paramName in thisIntervention_move:
                globals()[paramName] = thisIntervention_move[paramName]
        ...
        for thisIntervention_move in intervention_moves:
            ...
            continueRoutine = True
            # update component parameters for each repeat
            thisExp.addData('intervention_player_wait.started', globalClock.getTime())
            ...
            for thisComponent in intervention_player_waitComponents:
                if hasattr(thisComponent, "setAutoDraw"):
                    thisComponent.setAutoDraw(False)
            thisExp.addData('intervention_player_wait.stopped', globalClock.getTime())
            ...
            continueRoutine = True
            # update component parameters for each repeat
            thisExp.addData('intervention_npc_wait.started', globalClock.getTime())
            ...
            for thisComponent in intervention_npc_waitComponents:
                if hasattr(thisComponent, "setAutoDraw"):
                    thisComponent.setAutoDraw(False)
            thisExp.addData('intervention_npc_wait.stopped', globalClock.getTime())
        ...
        continueRoutine = True
        # update component parameters for each repeat
        thisExp.addData('who_won.started', globalClock.getTime())
        ...
        for thisComponent in who_wonComponents:
            if hasattr(thisComponent, "setAutoDraw"):
                thisComponent.setAutoDraw(False)
        thisExp.addData('who_won.stopped', globalClock.getTime())
    ...
    if thisDouble_click_3 != None:
        for paramName in thisDouble_click_3:
            globals()[paramName] = thisDouble_click_3[paramName]
    ...
    for thisDouble_click_3 in double_click_3:
        ...
        continueRoutine = True
        # update component parameters for each repeat
        thisExp.addData('section_3.started', globalClock.getTime())
        ...
        for thisComponent in section_3Components:
            if hasattr(thisComponent, "setAutoDraw"):
                thisComponent.setAutoDraw(False)
        thisExp.addData('section_3.stopped', globalClock.getTime())
    ...
    if thisMore_game != None:
        for paramName in thisMore_game:
            globals()[paramName] = thisMore_game[paramName]
    ...
    for thisMore_game in more_games:
        ...
        if thisMore_turn != None:
            for paramName in thisMore_turn:
                globals()[paramName] = thisMore_turn[paramName]
    ...
    continueRoutine = True
    # update component parameters for each repeat
    thisExp.addData('instruct_euclid.started', globalClock.getTime())
    ...
    for thisComponent in instruct_euclidComponents:
        if hasattr(thisComponent, "setAutoDraw"):
            thisComponent.setAutoDraw(False)
    thisExp.addData('instruct_euclid.stopped', globalClock.getTime())
    # store data for thisExp (ExperimentHandler)
    thisExp.nextEntry()
    ...
    continueRoutine = True
    # update component parameters for each repeat
    thisExp.addData('instruct_nim.started', globalClock.getTime())
    ...
    for thisComponent in instruct_nimComponents:
        if hasattr(thisComponent, "setAutoDraw"):
            thisComponent.setAutoDraw(False)
    thisExp.addData('instruct_nim.stopped', globalClock.getTime())
    # store data for thisExp (ExperimentHandler)
    thisExp.nextEntry()
    ...
    if thisDouble_click_4 != None:
        for paramName in thisDouble_click_4:
            globals()[paramName] = thisDouble_click_4[paramName]
    ...
    for thisDouble_click_4 in double_click_4:
        ...
        continueRoutine = True
        # update component parameters for each repeat
        thisExp.addData('section_4.started', globalClock.getTime())
        ...
        for thisComponent in section_4Components:
            if hasattr(thisComponent, "setAutoDraw"):
                thisComponent.setAutoDraw(False)
        thisExp.addData('section_4.stopped', globalClock.getTime())
    ...
    if thisNew_game != None:
        for paramName in thisNew_game:
            globals()[paramName] = thisNew_game[paramName]
    ...
    for thisNew_game in new_games:
        ...
        if thisTurn_4 != None:
            for paramName in thisTurn_4:
                globals()[paramName] = thisTurn_4[paramName]
